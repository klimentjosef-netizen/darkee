    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <article className="max-w-3xl mx-auto px-6 pt-28 pb-20">
        ...
        <div className="prose-darkee space-y-8 text-sm text-[var(--text-secondary)] font-[family-name:var(--font-body)] leading-relaxed">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">1. Správce osobních údajů</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">2. Jaké údaje zpracováváme</h2>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">3. Účel zpracování</h2>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">4. Doba uchování</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">5. Předávání údajů třetím stranám</h2>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">6. Vaše práva</h2>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">7. Zabezpečení</h2>
            <p>
          ...
          <section>
            <h2 className="font-[family-name:var(--font-display)] text-xl font-normal text-[var(--text-primary)] mb-3">8. Změny těchto zásad</h2>
            <p>
