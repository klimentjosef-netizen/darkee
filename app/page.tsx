        ...
        <div style={s.navInner}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
            ...
            <div style={s.navLinks} className="hidden md:flex">
              <Link href="#how" style={s.navLink('nl-how')} onMouseEnter={on('nl-how')} onMouseLeave={off('nl-how')} className="hidden md:inline">Jak to funguje</Link>
            </div>
          </div>
      ...
      <section style={s.footerWrap}>
        <div style={s.footerInner}>
          <div style={s.footerGrid}>
            ...
            {/* Pro uživatele */}
            <div>
              <div style={s.footerColTitle}>Navigace</div>
              {[['/#how','Jak to funguje'],['/pruvodce','Spustit kvíz'],['mailto:info@darkee.cz','Kontakt']].map(([href,label]) => (
