...
import { ChevronRight, Link2, Gift } from 'lucide-react'
              ...
              components={{
                ...
                table: ({ children }) => (
                  <div className="overflow-x-auto my-6">
                    <table className="w-full text-sm text-[var(--text-secondary)] font-[family-name:var(--font-body)] border-collapse">
                      {children}
                    </table>
                  </div>
                ),
                ...
                th: ({ children }) => (
                  <th className="text-left py-2 px-3 text-[var(--gold-primary)] font-medium text-xs tracking-wider uppercase">{children}</th>
                ),
                td: ({ children }) => (
                  <td className="py-2 px-3 border-b border-[var(--border-subtle)] text-sm">{children}</td>
                ),
